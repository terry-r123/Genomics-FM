...
class PetrelBackend:
    ...
    def get_lines_from_csv(self, filepath):
        d = self._client.get(filepath, enable_cache=True)
    ...
    # def put_file(self, local_filepath, s_filepath):
    #     self._client.put_file(s_filepath, local_filepath)
