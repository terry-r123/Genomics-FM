...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        use_alibi: bool = None,
        output_last_encoded_layers_cls: Optional[bool] = False,
        **kwargs
        ...
        if output_last_encoded_layers_cls:
            pdb.set_trace()
            encoder_outputs = encoder_outputs[-1][:, 0]
            
            if self.pooler is not None:
                return encoder_outputs, sequence_output, pooled_output
            else:
                return encoder_outputs, sequence_output
        else:
            if not output_all_encoded_layers:
